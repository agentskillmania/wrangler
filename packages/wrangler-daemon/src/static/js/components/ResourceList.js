  ...
  return html`
    <div>
      <div class="page-toolbar">
        ${onCreate &&
        html`
          <button class="btn btn-primary btn-sm" onClick=${onCreate}>+ ${onCreateLabel}</button>
        `}
      </div>
      <table class="table">
        <thead>
          <tr>
            ...
            ${actions && html`<th style="width:120px"></th>`}
          </tr>
        </thead>
        <tbody>
          ${items.length === 0
            ...
            : items.map(function (item) {
                return html`
                  ...
                  >
                    ...
                    ${actions && html` <td class="actions">${actions(item)}</td> `}
                  </tr>
                `;
              })}
        </tbody>
