...
export function SpecsPage() {
  ...
  function loadSpecs() {
    ...
    api
      .get('/api/specs?workspacePath=' + encodeURIComponent(workspacePath))
      .then(function (res) {
  ...
  function saveBody() {
    ...
    api
      .put('/api/specs/' + encodeURIComponent(selected.name) + '/' + selected.version, {
  ...
  function updateStatus() {
    ...
    api
      .patch(
        '/api/specs/' + encodeURIComponent(selected.name) + '/' + selected.version + '/status',
        {
          workspacePath: workspacePath,
          status: editStatus,
        }
    ...
    <div class="page">
      ...
      <div class="page-toolbar">
        <div class="field" style="min-width:300px;margin-bottom:0">
          ...
          <select class="input" value=${workspacePath} onChange=${function (e) {
              ...
              <div style="margin-bottom:4px">
                ...
                >
                  ${STATUSES.map(function (st) {
                    return html`<option value=${st}>${st}</option>`;
                  })}
                </select>
                <button
                  class="btn btn-secondary btn-sm"
                ...
                : detail.error
                  ...
                  : html`
                      ...
                      <div style="display:flex;align-items:center;gap:8px;margin-top:8px">
                        <button class="btn btn-primary btn-sm" onClick=${saveBody}>
                          Save Body
                        </button>
                        ${saveStatus &&
                        html`
                          <span
                            ...
                            (saveStatus.startsWith('Error')
                              ? 'var(--error)'
                              : saveStatus === 'saving...' || saveStatus === 'updating status...'
                                ? 'var(--warning)'
                                : 'var(--success)')}
                          >
                            ${saveStatus}
