...
export function PlansPage() {
  ...
  function loadPlans() {
    ...
    api
      .get('/api/plans?workspacePath=' + encodeURIComponent(workspacePath))
      .then(function (res) {
            ...
            <div class="row">
              ...
              <div class="field">
                ...
                <input
                  ...
                  onInput=${function (e) {
                    setNewSpecVersion(Number(e.target.value));
                  }}
                />
              </div>
            </div>
      ...
      <div class="card-grid">
        ...
        ${plans.map(function (p) {
          ...
          return html`
            <div
              class="card"
              key=${p.name + '-s' + p.specVersion + '-v' + p.version}
              onClick=${function () {
                openDetail(p);
              }}
            ...
            >
              ...
              <div class="card-meta">
                Spec: ${p.specName || '-'} v${p.specVersion || 1} · v${p.version || 1} ·
