...
function w(n) {
  ((!n.__d && (n.__d = !0) && i.push(n) && !x.__r++) || o !== l.debounceRendering) &&
    ((o = l.debounceRendering) || r)(x);
}
function x() {
...
function C(n, l, u, t, i, o, r, f, e, a, h) {
  ...
  for (u.__d = e, P(u, l, g), e = u.__d, v = 0; v < b; v++)
    null != (y = u.__k[v]) &&
      'boolean' != typeof y &&
      'function' != typeof y &&
      ((p = -1 === y.__i ? c : g[y.__i] || c),
      (y.__i = v),
      L(n, y, p, i, o, r, f, e, a, h),
      (d = y.__e),
      y.ref && p.ref != y.ref && (p.ref && z(p.ref, null, y), h.push(y.ref, y.__c || d, y)),
      null == _ && null != d && (_ = d),
    ...
    (i = n.__k[t] =
      null == (i = l[t]) || 'boolean' == typeof i || 'function' == typeof i
        ...
        : 'string' == typeof i ||
          ...
          ? d(null, i, null, null, i)
          : h(i)
            ? d(g, { children: i }, null, null, null)
            : void 0 === i.constructor && i.__b > 0
              ? d(i.type, i.props, i.key, i.ref ? i.ref : null, i.__v)
              : i)
      ? ((i.__ = n),
        (i.__b = n.__b + 1),
        (f = H(i, u, (r = t + a), s)),
      ...
      : (o = u[t]) &&
        null == o.key &&
        o.__e &&
        (o.__e == n.__d && (n.__d = m(o)), N(o, o, !1), (u[t] = null), s--);
  if (s)
    for (t = 0; t < c; t++)
...
function I(n, l, u) {
  '-' === l[0]
    ...
    : (n[l] = null == u ? '' : 'number' != typeof u || a.test(l) ? u : u + 'px');
}
  ...
  n: if ('function' == typeof A)
    try {
      if (
        ...
        t.__c
          ...
          : ('prototype' in A && A.prototype.render
              ? (u.__c = p = new A(w, P))
              : ((u.__c = p = new b(w, P)), (p.constructor = A), (p.render = O)),
            x && x.sub(p),
            (p.props = w),
            p.state || (p.state = {}),
            (p.context = P),
        ...
        null != A.getDerivedStateFromProps &&
          ...
          v(p.__s, A.getDerivedStateFromProps(w, p.__s))),
        (d = p.props),
        (_ = p.state),
        (p.__v = u),
        y)
        ...
        if (
          ...
          !p.__e &&
            ((null != p.shouldComponentUpdate && !1 === p.shouldComponentUpdate(w, p.__s, P)) ||
              u.__v === t.__v))
        ) {
          for (
            u.__v !== t.__v && ((p.props = w), (p.state = p.__s), (p.__d = !1)),
              u.__e = t.__e,
              u.__k = t.__k,
        ...
        (null != p.componentWillUpdate && p.componentWillUpdate(w, p.__s, P),
      ...
      if (
        ...
        for (
          p.state = p.__s, p.__d = !1, $ && $(u), a = p.render(p.props, p.state, p.context), I = 0;
          I < p._sb.length;
          I++
        )
          p.__h.push(p._sb[I]);
      ...
      ((p.state = p.__s),
        ...
        C(
          n,
          h((T = null != a && a.type === g && null == a.key ? a.props.children : a)) ? T : [T],
          u,
          t,
          i,
          o,
...
function j(l, u, t, i, o, r, f, e, s) {
  ...
  if (null === x) k === w || (e && l.data === w) || (l.data = w);
    ...
    if (((r = r && n.call(l.childNodes)), (k = t.props || c), !e && null != r))
      for (k = {}, a = 0; a < l.attributes.length; a++) k[(_ = l.attributes[a]).name] = _.value;
    for (a in k)
      ((_ = k[a]),
        'children' == a ||
          ('dangerouslySetInnerHTML' == a
            ? (y = _)
            : 'key' === a || a in w || T(l, a, null, _, o)));
    for (a in w)
      ((_ = w[a]),
        'children' == a
          ? (d = _)
            ...
            : 'value' == a
              ...
              : 'checked' == a
                ...
                : 'key' === a ||
                  ...
                  T(l, a, _, k[a], o));
    if (v)
      (e || (y && (v.__html === y.__html || v.__html === l.innerHTML)) || (l.innerHTML = v.__html),
        (u.__k = []));
    else if (
      (y && (l.innerHTML = ''),
      C(
      ...
      for (a = r.length; a--; ) null != r[a] && p(r[a]);
    e ||
      ((a = 'value'),
      void 0 !== g &&
        (g !== l[a] || ('progress' === x && !g) || ('option' === x && g !== k[a])) &&
        T(l, a, g, k[a], !1),
      (a = 'checked'),
      void 0 !== b && b !== l[a] && T(l, a, b, k[a], !1));
  }
  return l;
}
function z(n, u, t) {
...
function N(n, u, t) {
  ...
  if ((i = n.__k))
    for (o = 0; o < i.length; o++) i[o] && N(i[o], u, t || 'function' != typeof n.type);
...
function E(l, u, t) {
  ...
  return (
    ...
    d(l.type, e, i || l.key, o || l.ref, null)
  );
}
function F(n, l) {
  var u = {
...
((n = s.slice),
  ...
  (b.prototype.setState = function (n, l) {
    ...
    ((u = null != this.__s && this.__s !== this.state ? this.__s : (this.__s = v({}, this.state))),
      'function' == typeof n && (n = n(v({}, u), this.props)),
      n && v(u, n),
      null != n && this.__v && (l && this._sb.push(l), w(this)));
  }),
